        ...
        <div>
          {!this.state.isElStarted && !this.state.isElEnded ? (
                ...
                this.state.currentVoter.isVerified ? (
                  this.state.currentVoter.hasVoted ? (
                    ...
                    <div className="container-item info">
                      <center>You have been verified by the Admin. Go ahead and cast your vote now.</center>
                    </div>
                  )
                ) : (
                  <div className="container-item attention">
                    <center>Please wait for admin to verify your account.</center>
                  </div>
                )
              ) : (
                <>
                  <div className="container-item attention">
                    <center>
                      <p>You're not registered. Please register yourself.</p>
                      <br />
                      <Link
                        to="/Registration"
            ...
            <>
              <div className="container-item attention">
                <center>
                  <h3>The Election has now ended.</h3>
                  <br />
                  <Link
                    to="/Results"
                    style={{ color: "black", textDecoration: "underline" }}
