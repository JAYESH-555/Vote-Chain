        ...
        <div className="container-main">
          ...
          {!this.state.elStarted & !this.state.elEnded ? (
            <div className="container-item info">
              <center>
                <h3>The Election has not been initialized till now.</h3>
                {this.state.isAdmin ? (
        ...
        {this.state.isAdmin ? (
          ...
          <>
            <div className="container-item attention">
              <center>
                <h3>The Election has ended successfully!!.</h3>
                <br />
                <Link
                  to="/Results"
                    ...
                    <div>
                      ...
                      <label className="label-home">
                        ...
                        <input
                          className="input-home"
                          type="text"
                          placeholder="eg. Election Head or Council Head "
                          {...register("adminTitle", {
                            required: true,
                          })}
                        />
