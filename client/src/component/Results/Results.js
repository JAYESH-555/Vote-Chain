          ...
          {!this.state.isElStarted && !this.state.isElEnded ? (
            ...
            <div className="container-item attention">
              <center>
                ...
                <p>Result will be displayed once the election is officially ended by the Admin.</p>
      ...
      <div className="container-main" style={{ borderTop: "1px solid" }}>
        ...
        {candidates.length < 1 ? (
          ...
          <>
            ...
            >
              <center>Thank You for particicpating in Blockchain Voting System! Have a good day!</center>
            </div>
          </>
        )}
      </div>
